...
- [ ] Hover over `[[ID]]` shows markdown card with:
  - Title (as heading)
  - Status with colored indicator
  - Type with icon
  - Size
  - Epic name (for stories)
- [ ] Returns null/empty if ID not found
- [ ] Hover card is readable and well-formatted
...
- Status colors: Use emoji or unicode circles (●○◐◑)
